...
@Component({
  selector: 'app-report-1-dialog',
  templateUrl: './report-1-dialog.component.html',
  styleUrls: ['./report-1-dialog.component.css']
})
export class Report1DialogComponent implements OnInit, OnDestroy {
