...
import {MessageConfigurationAdd} from "../../state/ext-int-iso8583.actions";
import {MessageConfigurationDomain} from "../../domain/message-configuration.domain";

@Component({
  selector: 'app-iso8583-dialog',
  templateUrl: './iso8583-dialog.component.html',
  styleUrls: ['./iso8583-dialog.component.css']
})
export class Iso8583DialogComponent implements OnInit, OnDestroy {
  ...
  onSave(value: any) {
    ...
    this.extIntISO8583Service.onAddMessageConfiguration(fixData)
  }
